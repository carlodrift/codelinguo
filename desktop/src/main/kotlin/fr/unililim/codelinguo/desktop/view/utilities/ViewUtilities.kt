...
import fr.unililim.codelinguo.desktop.view.MainView
import fr.unililim.codelinguo.desktop.view.WordOccurrenceView
...
object ViewUtilities {
    ...
    fun openWordOccurrenceView(
        ...
        val view = WordOccurrenceView(wordRank, wordsInListNotInGlossary, glossaryRatio, lang, projectName, fileName)
